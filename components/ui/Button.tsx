...
// lumineux (.cta-shine défini dans globals.css), léger agrandissement + halo
// lime au survol, enfoncement à l'appui. Trois variantes.

type Variant = "primary" | "secondary" | "ghost";

const VARIANTS: Record<Variant, string> = {
  primary:
    "cta-shine bg-accent px-5 py-3 text-black hover:scale-[1.02] hover:shadow-[0_0_22px_rgba(203,255,3,0.45)] disabled:hover:scale-100",
  secondary:
