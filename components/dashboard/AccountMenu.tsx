    ...
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 top-11 z-30 w-56 overflow-hidden rounded-xl border border-border bg-bg-elevated shadow-xl">
          ...
          {/* Pur menu compte : la navigation vit dans la barre du bas et sur
              la Vue d'ensemble (raccourcis mobiles) ; ici, uniquement ce qui
              touche au compte. Visible sur mobile (sidebar masquée). */}
