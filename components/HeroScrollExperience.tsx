    ...
    <>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-5 sm:px-6 pt-20 lg:pt-32 pb-14 lg:pb-28 overflow-hidden text-center">
        ...
        <div className="relative max-w-4xl mx-auto w-full">
          ...
          >
            <span className="flex items-center gap-1.5"><Check />{launched ? "Sans carte bancaire" : "Sans engagement"}</span>
            <span className="hidden sm:flex items-center gap-1.5"><Check />{launched ? "Facture envoyée automatiquement" : "Accès sélectionné manuellement"}</span>
            <span className="flex items-center gap-1.5"><Check />{launched ? "Pro essayable 7 jours" : "Paiements sécurisés par Stripe"}</span>
          </motion.div>

          {/* Offre du moment : après la promesse et les boutons, comme un
              bonus qu'on découvre, pas un bandeau qui bloque la lecture. */}
          <motion.div
            className="mt-5 flex justify-center sm:mt-7"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
  ...
  return (
    <div style={{ paddingTop: 52, height: "100%", display: "flex", flexDirection: "column", padding: "52px 14px 14px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 7 }}>
        ...
        <span style={{ fontSize: 9, color: "var(--text-dim)" }}>ou par carte</span>
        <div style={{ flex: 1, height: 1, background: "rgba(255,255,255,0.08)" }} />
      </div>
      <div style={{ padding: "8px 12px", borderRadius: 10, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.12)", marginBottom: 5 }}>
        <div style={{ fontSize: 9, color: "var(--text-dim)", marginBottom: 3 }}>Numéro de carte</div>
      ...
      <div className="phone-scroll" style={{ flex: 1, overflowY: "auto", padding: "8px 14px 14px", display: "flex", flexDirection: "column", gap: 7 }}>
        ...
        <div style={{ padding: "9px 10px", borderRadius: 12, background: "rgba(203,255,3,0.05)", border: "1px solid rgba(203,255,3,0.2)" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
            <div style={{ fontSize: 8, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.06em", color: "var(--text-dim)" }}>Prochaine séance</div>
        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 5 }}>
            <div style={{ fontSize: 8, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.06em", color: "var(--text-dim)" }}>Factures</div>
          ...
          {[
            ...
            <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "6px 9px", borderRadius: 8, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)", marginBottom: 3 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
                ...
                <svg width="8" height="8" viewBox="0 0 24 24" fill="none"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3" stroke="var(--text-dim)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
              </div>
            </div>
          ))}
        </div>
        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 5 }}>
            <div style={{ fontSize: 8, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.06em", color: "var(--text-dim)" }}>Historique</div>
            <span style={{ fontSize: 8, color: "#CBFF03" }}>Voir tout</span>
          </div>
          {[
