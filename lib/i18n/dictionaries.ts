...
const fr = {
  ...
  plans: {
    ...
    modalTitle: "Garde 100 % de tes séances",
    modalBody:
      "En Gratuit, Madger prend 5 % sur chaque séance encaissée. En Pro, c'est 0 %, avec les statistiques avancées et le support prioritaire. Essaie 7 jours, rien n'est débité.",
    modalPoints: [
      "0 % de commission sur tes encaissements",
      "Statistiques avancées et objectifs",
      "Support prioritaire",
      "7 jours d'essai, résiliable en un clic",
    ],
    modalCta: "Essayer Pro 7 jours gratuits",
    modalLater: "Plus tard",
    upsellPaymentsTitle: "5 % de commission sur chaque séance",
    upsellPaymentsDesc: "En Pro, tu gardes tout. Le Pro se rembourse dès 980 € encaissés par mois.",
    ...
    upsellCardCta: "Voir l'offre Pro",
  },
  promo: {
...
const en: Dictionary = {
  ...
  plans: {
    ...
    modalTitle: "Keep 100% of your sessions",
    modalBody:
      "On Free, Madger takes 5% on every session collected. On Pro, it is 0%, with advanced statistics and priority support. Try it for 7 days, nothing is charged.",
    modalPoints: [
      "0% commission on your payments",
      "Advanced statistics and goals",
      "Priority support",
      "7-day trial, cancel in one click",
    ],
    modalCta: "Try Pro free for 7 days",
    modalLater: "Later",
    upsellPaymentsTitle: "5% commission on every session",
    upsellPaymentsDesc: "On Pro you keep everything. Pro pays for itself from 980 € collected per month.",
    ...
    upsellCardCta: "See the Pro offer",
  },
  promo: {
