...
const fr = {
  ...
  plans: {
    ...
    proActive: "Pro actif",
    welcomePro:
      "Bienvenue en Pro. Packs, annulation automatique, relances, écran encaissements et alertes churn débloqués.",
    ...
    upsellDesc: "Packs, annulation automatique, relances, écran encaissements, alertes churn.",
    ...
    modalPoints: [
      ...
      "Prix de lancement bloqué à vie, 7 jours d'essai, résiliable en un clic",
    ],
    ...
    upsellStatsDesc: "Tendances, répartition par prestation, objectifs suivis chaque semaine.",
...
const en: Dictionary = {
  ...
  plans: {
    ...
    welcomePro:
      "Welcome to Pro. Packs, automatic cancellation, renewal reminders, payments screen and churn alerts unlocked.",
    proUntil: "Pro until",
    daysLeft: "days left",
    ...
    upsellTitle: "Go Pro",
    upsellDesc: "Packs, automatic cancellation, reminders, payments screen, churn alerts.",
    ...
    modalPoints: [
      ...
      "Launch price locked for life, 7-day trial, cancel in one click",
    ],
    ...
    upsellStatsDesc: "Trends, breakdown by service, goals tracked every week.",
