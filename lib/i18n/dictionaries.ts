...
const fr = {
  ...
  onboarding: {
    ...
    photoTitle: "Ta photo et ta présentation",
    photoSubtitle:
      "Les coachs avec une vraie photo reçoivent nettement plus de demandes.",
    addPhoto: "Ajouter ma photo",
    changePhoto: "Changer de photo",
    photoHint: "Image nette, lumière naturelle. 5 Mo max.",
    ...
    serviceTitle: "Ta première prestation",
    serviceSubtitle:
      "Celle que les clients pourront réserver et payer en ligne. Tu pourras en ajouter d'autres ensuite.",
    servicePlaceholder: "Ex : Séance individuelle 1 h",
    serviceInvalid: "Donne un nom et un prix à ta prestation.",
    availTitle: "Tes disponibilités",
    availSubtitle:
      "Tes jours et ta plage horaire type. Ajustables à tout moment dans les réglages.",
...
const en: Dictionary = {
  ...
  onboarding: {
    ...
    serviceSubtitle:
      "The one clients can book and pay online. You can add more later.",
    servicePlaceholder: "E.g. 1:1 session, 1 h",
    serviceInvalid: "Give your service a name and a price.",
    availTitle: "Your availability",
    availSubtitle:
      "Your typical days and time range. Adjustable anytime in settings.",
