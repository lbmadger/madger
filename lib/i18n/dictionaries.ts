...
const fr = {
  ...
  agenda: {
    ...
    form: {
      ...
      meetingUrlHint: "Laisse vide : un lien Google Meet est créé tout seul si ton agenda Google est connecté (Réglages).",
      notes: "Notes",
      create: "Planifier",
      creating: "Planification…",
...
const en: Dictionary = {
  ...
  agenda: {
    ...
    form: {
      ...
      meetingUrlPlaceholder: "https://meet.google.com/…",
      meetingUrlHint: "Leave empty: a Google Meet link is created automatically if your Google Calendar is connected (Settings).",
      notes: "Notes",
      create: "Schedule",
      creating: "Scheduling…",
