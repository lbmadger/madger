...
const fr = {
  ...
  plans: {
    ...
    retain: {
      ...
      offerIntro: {
        too_expensive:
          "On comprend. Deux options pour alléger la note sans perdre le 0 % de commission.",
        not_enough_revenue:
          "Le Pro se rembourse à partir d'environ 980 € encaissés par mois. En dessous, le Gratuit est un bon choix, mais regarde d'abord ce que tu as réellement évité.",
        missing_features:
      ...
      offerMonthDesc: "49 € crédités sur ta prochaine facture, une seule fois.",
      ...
      confirmLoss: [
        ...
        "Tu perds le prix de lancement de 49 € : si tu reviens plus tard, c'est le tarif en vigueur.",
      ],
    ...
    offerDaysLeft: "Plus que {n} jours pour bloquer ce prix à vie",
    offerLastDay: "Dernier jour pour bloquer ce prix à vie",
    offerLocked: "Bloqué tant que tu restes abonné, même après la hausse.",
    modalTitle: "Chaque séance en Gratuit te coûte 5 %",
    modalBody:
      "Une séance à 50 € encaissée en Gratuit, c'est 2,50 € qui partent chez Madger. Vingt séances par mois, c'est déjà le prix du Pro. En Pro, tu gardes 100 % de chaque encaissement, avec les statistiques avancées et le support prioritaire.",
    modalPoints: [
      "0 % de commission : chaque euro encaissé est à toi",
      "Prix de lancement bloqué à vie, même après la hausse",
      "Statistiques avancées, objectifs et support prioritaire",
      "7 jours d'essai, rien n'est débité, résiliable en un clic",
    ],
    modalCta: "Bloquer 49 € et essayer 7 jours",
    modalLater: "Plus tard",
    upsellPaymentsTitle: "5 % de commission sur chaque séance, dès le premier euro",
    upsellPaymentsDesc: "En Pro, tu gardes 100 %. Le Pro se rembourse dès 980 € encaissés par mois, et tu bloques le prix de lancement à vie.",
    upsellStatsTitle: "Tes statistiques avancées t'attendent en Pro",
    upsellStatsDesc: "Tendances, répartition par prestation, objectifs suivis chaque semaine. Et 0 % de commission.",
    upsellInvoicesTitle: "Zéro commission sur ces factures",
    upsellInvoicesDesc: "En Pro, chaque facture encaissée te revient à 100 %, frais Stripe seuls déduits.",
  ...
  invoices: {
    ...
    madgerMovedHint: "Les factures Madger (commission de service) sont sur la page",
...
const en: Dictionary = {
  ...
  plans: {
    ...
    retain: {
      ...
      offerIntro: {
        too_expensive:
          "We get it. Two options to lighten the bill without losing the 0% commission.",
        not_enough_revenue:
          "Pro pays for itself from about 980 € collected per month. Below that, Free is a fine choice, but first look at what you actually avoided.",
        missing_features:
      ...
      offerMonthDesc: "49 € credited on your next invoice, one time only.",
      ...
      confirmLoss: [
        ...
        "You lose the 49 € launch price: if you come back later, the current rate applies.",
      ],
    ...
    offerDaysLeft: "Only {n} days left to lock this price for life",
    offerLastDay: "Last day to lock this price for life",
    offerLocked: "Locked as long as you stay subscribed, even after the increase.",
    modalTitle: "Every session on Free costs you 5%",
    modalBody:
      "A 50 € session collected on Free means 2.50 € going to Madger. Twenty sessions a month is already the price of Pro. On Pro, you keep 100% of every payment, with advanced statistics and priority support.",
    modalPoints: [
      "0% commission: every euro collected is yours",
      "Launch price locked for life, even after the increase",
      "Advanced statistics, goals and priority support",
      "7-day trial, nothing charged, cancel in one click",
    ],
    modalCta: "Lock 49 € and try for 7 days",
    modalLater: "Later",
    upsellPaymentsTitle: "5% commission on every session, from the first euro",
    upsellPaymentsDesc: "On Pro you keep 100%. Pro pays for itself from 980 € collected per month, and you lock the launch price for life.",
    upsellStatsTitle: "Your advanced statistics are waiting on Pro",
    upsellStatsDesc: "Trends, breakdown by service, goals tracked every week. And 0% commission.",
    upsellInvoicesTitle: "Zero commission on these invoices",
    upsellInvoicesDesc: "On Pro, every collected invoice is 100% yours, Stripe fees only.",
  ...
  invoices: {
    ...
    madgerMovedHint: "Madger invoices (service commission) live on the",
