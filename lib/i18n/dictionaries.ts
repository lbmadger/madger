...
const fr = {
  ...
  agenda: {
    ...
    form: {
      ...
      duration: "Durée",
      location: "Lieu",
      onlineNeedsGoogle: "Visio : connecte ton agenda Google dans Réglages.",
      ...
      meetingUrlHint: "Laisse vide : un lien visio est créé tout seul (Google Meet si ton agenda Google est connecté, sinon une salle Madger).",
      notes: "Notes",
      create: "Planifier",
      creating: "Planification…",
  ...
  services: {
    ...
    form: {
      ...
      packBase: "Séance vendue dans ce pack",
      packBaseFree: "Aucune, je remplis moi-même",
      packBaseNone: "Crée d'abord une séance individuelle : le pack se remplira tout seul.",
      packAutoName: "Pack {n} × {name}",
      packPriceFull: "{n} × {unit} = {total}",
      packPricePerSession: "Soit {unit} par séance.",
      packPriceDiscount: "Soit {unit} par séance, {pct} % de remise.",
  ...
  clients: {
    ...
    detail: {
      ...
      gestureRefunded: "Remboursé {amount}",
  ...
  settings: {
    ...
    onlineNeedsGoogle: "Pour proposer la visio, connecte ton agenda Google (le lien Meet est créé tout seul).",
    slug: "Lien public",
  ...
  reservation: {
    ...
    copyLink: "Copier",
    copied: "Copié",
    meetPending: "Le lien visio arrive ici dès que la séance est confirmée. Tu le recevras aussi par email.",
  ...
  clientOnboarding: {
    ...
    photoRecrop: "Recadrer",
    photoUploading: "Envoi…",
    photoHint: "Ton coach te reconnaît au premier coup d'œil.",
    photoErr: "Photo impossible à envoyer (image de 10 Mo maximum).",
    firstName: "Prénom",
    lastName: "Nom",
    phone: "Téléphone",
  ...
  clientSpace: {
    ...
    profileBanner: "Complète ton profil sportif avant ta séance : ton coach saura à qui il a affaire.",
    profileBannerCta: "Compléter mon profil",
    upcoming: "À venir",
    past: "Passées",
  ...
  creditBooking: {
    ...
    weekLimit: "Ton pack : {n} séance(s) par semaine au maximum. Les semaines déjà pleines sont grisées.",
    weekFull: "Semaine complète : {n} séance(s) maximum avec ce pack.",
    submit: "Réserver",
...
const en: Dictionary = {
  ...
  agenda: {
    ...
    form: {
      ...
      duration: "Duration",
      location: "Location",
      onlineNeedsGoogle: "Video: connect your Google Calendar in Settings.",
      inPerson: "In person",
      online: "Online",
      ...
      meetingUrlPlaceholder: "https://meet.google.com/…",
      meetingUrlHint: "Leave empty: a video link is created automatically (Google Meet if your Google Calendar is connected, otherwise a Madger room).",
      notes: "Notes",
      create: "Schedule",
      creating: "Scheduling…",
  ...
  services: {
    ...
    form: {
      ...
      packBase: "Session sold in this pack",
      packBaseFree: "None, I'll fill it in myself",
      packBaseNone: "Create a one-to-one session first: the pack will fill itself in.",
      packAutoName: "{n}-session pack · {name}",
      packPriceFull: "{n} × {unit} = {total}",
      packPricePerSession: "That's {unit} per session.",
      packPriceDiscount: "That's {unit} per session, {pct}% off.",
  ...
  clients: {
    ...
    detail: {
      ...
      gestureRefunded: "Refunded {amount}",
  ...
  settings: {
    ...
    onlineNeedsGoogle: "To offer video sessions, connect your Google Calendar (the Meet link is created automatically).",
    slug: "Public link",
  ...
  reservation: {
    ...
    copyLink: "Copy",
    copied: "Copied",
    meetPending: "The video link appears here as soon as the session is confirmed. You will also get it by email.",
  ...
  clientOnboarding: {
    ...
    photoRecrop: "Recrop",
    photoUploading: "Uploading…",
    photoHint: "Your coach recognises you at a glance.",
    photoErr: "Could not upload the photo (image up to 10 MB).",
    firstName: "First name",
    lastName: "Last name",
    phone: "Phone",
  ...
  clientSpace: {
    ...
    profileBanner: "Complete your sports profile before your session: your coach will know who they are dealing with.",
    profileBannerCta: "Complete my profile",
    upcoming: "Upcoming",
    past: "Past",
  ...
  creditBooking: {
    ...
    weekLimit: "Your pack: up to {n} session(s) per week. Full weeks are greyed out.",
    weekFull: "Week full: {n} session(s) max with this pack.",
    submit: "Book",
    submitting: "Booking…",
